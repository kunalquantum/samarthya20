...
function Header() {
  ...
  return (
    <div className=" absolute mt-5 flex w-full flex-wrap items-center justify-between gap-2 px-5 text-xs font-medium uppercase opacity-90 md:px-10">
      <Head>
        <title>Samarthya 2.0</title>
      </Head>
      <div className="  flex items-center gap-2 font-medium tracking-[6px]">
        <IoIosGlobe className=" text-xl" />
        Samarthya 2.0
      </div>
      <ul className=" flex flex-wrap items-center gap-3 text-[16px] md:gap-10">
